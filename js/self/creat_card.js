...
//creat crad tab&doc
function ListShow(CId, CType, CUrl, CName, CSUTm, CSSta, CSDLine, CSdA,TabMNa,CirSmp) {
	switch(CType) {
		case 0:
	...
	if(CSSta == "待签") {
		var EleText = "<ul class='mui-table-view mui-card my_list my_marginbottom10px'><li class='mui-table-view-cell " + CType + "'><a class='a_color' href='" + CUrl + "?'><span class='mui-icon mui-icon-gear mui-pull-left my_fontweight my_color_white'></span><p class='mui-ellipsis my_style2'>" + "<span class='CName'>" + TabMNa + "</span>" + "<span class='CirSmp' hidden='hidden'>" + CirSmp + "</span>" + "<span class='CSdA' hidden='hidden'>" + CSdA + "</span>" + "<span class='CId' hidden='hidden'>" + CId + "</span>" + "</p></a><li class='mui-table-view-cell'><p class='mui-ellipsis my_style1'>表单名称：" + CName + "</p></li><li class='mui-table-view-cell'><p class='mui-ellipsis my_style1'>提交日期：" + CSUTm + "</p></li><li class='mui-table-view-cell'><p class='mui-ellipsis my_style1'>签批状态：" + CSSta + "</p></li><li class='mui-table-view-cell'><p class='mui-ellipsis my_style1'>截止日期：" + CSDLine + "</p></li></li></ul>"
